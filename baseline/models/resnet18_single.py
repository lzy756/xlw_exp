"""Single-head ResNet18 for FedAvg/FedProx baseline experiments.

This model differs from ResNet18_EAPH in that:
...
class ResNet18Single(nn.Module):
    """Single-head ResNet18 for global federated learning.

    A standard ResNet-18 model with a single classification head,
    ...
    def __init__(
        ...
        """Initialize ResNet18 with single global head.
