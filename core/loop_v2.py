...
from core.aggregator import (
    aggregate_theta_v2,
    aggregate_phi_domain_v2,
    fair_weighted_aggregate_v2
)
    ...
    for round_num in range(1, total_rounds + 1):
        ...
        for domain in domains:
            if domain_phi_updates[domain]:
                aggregated_phi = aggregate_phi_domain_v2(
        ...
        if all_theta_updates:
            ...
            if use_fair_weighting:
                ...
                theta_global = fair_weighted_aggregate_v2(
                ...
                theta_global = aggregate_theta_v2(
